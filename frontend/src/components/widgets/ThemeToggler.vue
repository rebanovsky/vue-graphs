  ...
  <div class="theme-togglers">
    <!-- <div class="theme-names">
      <div
        class="sb-icon-name"
        :class="
          isHovered == 'theme-toggle'
            ? 'hover-item light'
            : 'mouseleave light'
        "
      >
        <div v-if="isDark">Light</div>
      </div>
      <div
        class="sb-icon-name"
        :class="
        ...
        "
      >
        <div v-if="!isDark">Dark</div>
      </div>
    </div> -->
    <div
      class="toggle-theme"
      @click="toggleDark()"
      @mouseover="isHovered = 'theme-toggle'"
      @mouseleave="isHovered = 'mouseleave light'"
    >
      <div class="theme-icon" v-if="isDark">
        ...
        >
          <g>
            <path
              d="M256,384c-70.7,0-128-57.3-128-128s57.3-128,128-128s128,57.3,128,128S326.7,384,256,384z M256,0
...
export default {
  setup() {
    ...
    return { isDark, toggleDark, isHovered };
  },
};
</script>
