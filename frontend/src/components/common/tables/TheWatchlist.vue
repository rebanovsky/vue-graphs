<template>
    <div class="border-[1px] border-slate-200 rounded-[12px]">
      <div
        class="table-header flex justify-between items-center p-[6px] h-[60px] rounded-[12px] gridlines"
      >
      ...
      <div class="table-wrapper flex h-full">
        ...
        >
          ...
          >
            ...
            >
              <div
                class="flex  py-[8px] items-center cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 border-b-[1px] border-slate-200 dark:border-slate-800"
