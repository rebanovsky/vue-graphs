<template>
  <div class="legal-content">
    <div class="legal-title">
      ...
      <p class="dark:text-slate-400 text-slate-600">Updated at 2023-04-11</p>
    </div>
    <div class="legal-wrapper mt-[32px]">
      <div
        class="shadow-top transition ease shadow-scrollshtop dark:shadow-scrollshtopdark"
        :class="{ visible: isScrolledTop, '!w-[100vw]': isMobileDevice }"
      ></div>
      <div
        class="overflow-y-auto w-[100vw] flex justify-center"
        ref="tableContainer"
      ...
      >
        <div class="legal-items">
          <h1>General Terms</h1>
          <p>
            By accessing and placing an order with InsiderHive, you confirm that
            ...
            communication between you and InsiderHive.
          </p>
          <p>
            Under no circumstances shall InsiderHive team be liable for any
            ...
            even if InsiderHive team or an authorized representative has been
          ...
          <p>
            InsiderHive will not be responsible for any outcome that may occur
            ...
            <a target="_blank" href="https://termify.io">Termify</a>.
          </p>

          <h1>License</h1>
          <p>
            InsiderHive grants you a revocable, non-exclusive, non-transferable,
            limited license to download, install and use the website strictly in
            accordance with the terms of this Agreement.
          </p>
          <p>
            These Terms & Conditions are a contract between you and InsiderHive
            (referred to in these Terms & Conditions as "InsiderHive", "us",
            "we" or "our"), the provider of the InsiderHive website and the
            services accessible from the InsiderHive website (which are
          ...
          <p>
            ...
            InsiderHive Service. In these Terms & Conditions, "you" refers both
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Revalia Capital LLC, Tallinn, Estonia that is
              responsible for your information under this Terms & Conditions.
            </li>
            <li>
              Country: where InsiderHive or the owners/founders of InsiderHive
              are based, in this case is EE
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit InsiderHive
              and use the services.
            </li>
            <li>
              Service: refers to the service provided by InsiderHive as
            ...
            <li>
              Website: InsiderHive's site, which can be accessed via this URL:
              www.insiderhive.com
            </li>
            <li>
              You: a person or entity that is registered with InsiderHive to use
              the Services.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) of InsiderHive or its
              affiliates, partners, suppliers or the licensors of the website.
            </li>
          </ul>
          <!-- <h1>Return and Refund Policy</h1>
          <p>
            Thanks for shopping at InsiderHive. We appreciate the fact that you
          ...
          <p>
            ...
            apply to transactions at InsiderHive. We’ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at InsiderHive, you agree to the terms
            along with InsiderHive's Privacy Policy.
          </p>
          <p>
          ...
          <p>
            ...
            (collectively, "Suggestions") provided by you to InsiderHive with
            respect to the website shall remain the sole and exclusive property
            of InsiderHive.
          </p>
          <p>
            InsiderHive shall be free to use, copy, modify, publish, or
          ...
          <p>
            ...
            InsiderHive. We are not responsible for the content, accuracy or
          ...
          <h1>Cookies</h1>
          <p>
            InsiderHive uses "Cookies" to identify the areas of our website that
          ...
          <p>
            You acknowledge and agree that InsiderHive may stop (permanently or
            temporarily) providing the Service (or any features within the
            Service) to you or to users generally at InsiderHive’s sole
            discretion, without prior notice to you. You may stop using the
            Service at any time. You do not need to specifically inform
            InsiderHive when you stop using the Service. You acknowledge and
            agree that if InsiderHive disables access to your account, you may
          ...
          <p>
            InsiderHive reserves the right to modify, suspend or discontinue,
          ...
          <p>
            InsiderHive may from time to time provide enhancements or
          ...
          <p>
            ...
            of the website. You agree that InsiderHive has no obligation to (i)
          ...
          <p>
            You acknowledge and agree that InsiderHive shall not be responsible
            for any Third-Party Services, including their accuracy,
            completeness, timeliness, validity, copyright compliance, legality,
            decency, quality or any other aspect thereof. InsiderHive does not
          ...
          <p>
            InsiderHive may, in its sole discretion, at any time and for any or
          ...
          <p>
            ...
            InsiderHive, in the event that you fail to comply with any provision
          ...
          <p>
            Termination of this Agreement will not limit any of InsiderHive's
          ...
          <p>
            You agree to indemnify and hold InsiderHive and its parents,
          ...
          <p>
            ...
            extent permitted under applicable law, InsiderHive, on its own
            ...
            foregoing, InsiderHive provides no warranty or undertaking, and
          ...
          <p>
            Without limiting the foregoing, neither InsiderHive nor any
            InsiderHive's provider makes any representation or warranty of any
            ...
            on behalf of InsiderHive are free of viruses, scripts, trojan
          ...
          <p>
            ...
            liability of InsiderHive and any of its suppliers under any
          ...
          <p>
            ...
            InsiderHive or its suppliers be liable for any special, incidental,
            ...
            InsiderHive or any supplier has been advised of the possibility of
          ...
          <p>
            ...
            notices published by InsiderHive on the Services, shall constitute
            the entire agreement between you and InsiderHive concerning the
            ...
            waiver of such term or any other term, and InsiderHive's failure to
            assert any right or provision under this Agreement shall not
            constitute a waiver of such right or provision. YOU AND InsiderHive
          ...
          <p>
            InsiderHive reserves the right, at its sole discretion, to modify or
          ...
          <p>
            ...
            InsiderHive regarding your use of the website and supersedes all
          ...
          <p>
            ...
            when you use or purchase other InsiderHive's services, which
            InsiderHive will provide to you at the time of such use or purchase.
          </p>
          ...
          <p>
            ...
            arrangement thereof), are owned by InsiderHive, its licensors or
            other providers of such material and are protected by EE and
            ...
            permission of InsiderHive, unless and except as is expressly
          ...
          <p>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR InsiderHive's
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and InsiderHive concerning
          ...
          <p>
            In the event of a dispute, you or InsiderHive must give the other a
            ...
            send any Notice of Dispute via email to: <a
              ...
              class="__cf_email__"
              data-cfemail="2d44434b426d44435e4449485f45445b48034e424003"
              >[email&#160;protected]</a
            >
            InsiderHive will send any Notice of Dispute to you by mail to your
            address if we have it, or otherwise to your email address. You and
            InsiderHive will attempt to resolve any dispute through informal
            negotiation within sixty (60) days from the date the Notice of
            Dispute is sent. After sixty (60) days, you or InsiderHive may
            commence arbitration.
          </p>

          <h1>Binding Arbitration</h1>
          <p>
            If you and InsiderHive don’t resolve any dispute by informal
          ...
          <p>
            ...
            property of InsiderHive without any compensation or credit to you
            whatsoever. InsiderHive and its affiliates shall have no obligations
          ...
          <h1>Promotions</h1>
          <p>
            InsiderHive may, from time to time, include contests, promotions,
          ...
          <p>
            ...
            signed by an authorized representative of InsiderHive. InsiderHive
            ...
            breach or anticipatory breach by you. InsiderHive operates and
            controls the InsiderHive Service from its offices in EE. The Service
            ...
            choose to access the InsiderHive Service from other locations do so
            ...
            InsiderHive Privacy Policy) contains the entire understanding, and
            supersedes all prior understandings, between you and InsiderHive
          ...
          <h1>Disclaimer</h1>
          <p>
            InsiderHive is not responsible for any content, code or any other
            imprecision.
          </p>
          <p>InsiderHive does not provide warranties or guarantees.</p>
          <p>
            In no event shall InsiderHive be liable for any special, direct,
          ...
          <p>
            The InsiderHive Service and its contents are provided "as is" and
            "as available" without any warranty or representations of any kind,
            whether express or implied. InsiderHive is a distributor and not a
            publisher of the content supplied by third parties; as such,
            InsiderHive exercises no editorial control over such content and
            ...
            provided through or accessible via the InsiderHive Service. Without
            limiting the foregoing, InsiderHive specifically disclaims all
            warranties and representations in any content transmitted on or in
            connection with the InsiderHive Service or on sites that may appear
            as links on the InsiderHive Service, or in the products provided as
            a part of, or otherwise in connection with, the InsiderHive Service,
            including without limitation any warranties of merchantability,
            fitness for a particular purpose or non-infringement of third party
            rights. No oral advice or written information given by InsiderHive
            ...
            InsiderHive does not warrant that the InsiderHive Service will be
          ...
          <p class="pb-[48px]">
            ...
            <em class="font-medium">
              <a
                href="/cdn-cgi/l/email-protection"
                class="__cf_email__"
                data-cfemail="89e0e7efe6c9e0e7fae0edecfbe1e0ffeca7eae6e4"
                >info@insiderhive.com</a
              >
            </em>
          </p>
        </div>
        <div
          class="shadow-bottom transition ease shadow-scrollshbot dark:shadow-scrollshbotdark"
          :class="{ visible: isScrolledBottom }"
        ></div>
      </div>
    </div>
  </div>
...
export default {
  setup() {
    ...
    const isScrolledBottom = ref(true);
